...
event.recipes.create.mixing(Fluid.of('kubejs:lesser_luck_potion',250), [Fluid.of('minecraft:water',250),'confluence:waterleaf','confluence:ladybug','confluence:white_pearl']).heated()
event.recipes.create.mixing(Fluid.of('kubejs:lifeforce_potion',250), [Fluid.of('minecraft:water',250),'confluence:moonglow','confluence:prismite','confluence:shiverthorn','confluence:moonglow']).heated()
...
event.recipes.create.emptying([Fluid.of('kubejs:venom'), 'minecraft:glass-bottle'], 'confluence:vial_of_venom')
...
event.recipes.create.filling('confluence:archery_potion', [Fluid.of('kubejs:archey_potion',250), 'minecraft:glass_bottle'])
...
event.recipes.create.filling('confluence:gravitation_potion', [Fluid.of('kubejs:_potion',250), 'minecraft:glass_bottle'])
event.recipes.create.filling('confluence:greater_luck_potion', [Fluid.of('kubejs:_potion',250), 'minecraft:glass_bottle'])
event.recipes.create.filling('confluence:heartreach_potion', [Fluid.of('kubejs:_potion',250), 'minecraft:glass_bottle'])
event.recipes.create.filling('confluence:hunter_potion', [Fluid.of('kubejs:_potion',250), 'minecraft:glass_bottle'])
event.recipes.create.filling('confluence:inferno_potion', [Fluid.of('kubejs:_potion',250), 'minecraft:glass_bottle'])
event.recipes.create.filling('confluence:ironskin_potion', [Fluid.of('kubejs:_potion',250), 'minecraft:glass_bottle'])
event.recipes.create.filling('confluence:lesser_luck_potion', [Fluid.of('kubejs:_potion',250), 'minecraft:glass_bottle'])
event.recipes.create.filling('confluence:lifeforce_potion', [Fluid.of('kubejs:lifeforce_potion_potion',250), 'minecraft:glass_bottle'])
event.recipes.create.filling('minecraft:luck_potion', [Fluid.of('kubejs:luck_potion',250), 'minecraft:glass_bottle'])
...
event.recipes.create.filling('confluence:obsidian_skin_potion', [Fluid.of('kubejs:_potion',250), 'minecraft:glass_bottle'])
...
event.recipes.create.filling('confluence:venom_bullet', [Fluid.of('kubejs:venom',2), 'confluence:empty_bullet'])
